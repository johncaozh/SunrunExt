      ...
      <div>
        <div v-if="voiceMessageContext.mediaId" class="flexDiv-h" style="align-items:flex-end">
          <div class="border" style="padding:10px;width:200px;">
            <div class="flexDiv-h border" style="padding:10px;margin-right:10px;">
        ...
        <div class="flexDiv-h" style="align-items:center" v-else>
          <el-upload class="avatar-uploader" :action="uploadUrl" :show-file-list="false" :on-success="handleVoiceSuccess" :before-upload="beforeVoiceUpload"
            v-loading="voiceMessageContext.isUploading">
            <div class="flexDiv-v border">
              <i class="el-icon-plus icon-plus "></i>
              添加语音
            </div>
  ...
  export default {
    data() {
      return {
        ...
        voiceMessageContext: {
          ...
          mp3MediaId: null, //mp3媒体ID, 由于Web播放Amr文件比较麻烦，故当上次音频文件时，返回amr和mp3两个媒体ID
          duration: 0, //秒为单位
          fileName: null,
        },
    ...
    methods: {
      ...
      handleVoiceSuccess(res, file) {
        ...
        // this.voiceMessageContext.mp3MediaId = res.data.mp3MediaId; 
        // this.voiceMessageContext.duration = res.data.duration;
        this.voiceMessageContext.mediaId = res.data;
        this.voiceMessageContext.mp3MediaId = res.data;
        this.voiceMessageContext.duration = 13;
      },
      ...
      cleanVoiceMessageContext() {
        ...
        this.voiceMessageContext.mp3MediaId = null;
        this.voiceMessageContext.isUploading = false;
      }
    }
  };
